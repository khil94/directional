...
import EditDeleteButton from "../components/editDeleteBtn";
import PreviousButton from "../components/previousBtn";
    ...
    <div className="bg-white py-12 sm:py-16">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          {auth && <EditDeleteButton id={data.id} />}
        </div>
      </div>
    </div>
  );
